<?php
	...
	class Config implements I\IConfig {
        ...
        public function getDriver(){
            if(!$this->Driver ){
                $driverClass = '\\Techy\Lib\Core\\Database\\Driver\\'. $this->get( 'driver' );
        ...
        public function getTemplator(){
            if(!$this->Templator ){
                $this->Templator = new \Techy\Lib\Core\Database\Helper\BlitzTemplator( $this );
            }
        ...
        public static function instance( $name ){
            ...
            if(!array_key_exists( $name, self::$configs ))
                self::$configs[$name] = new static( static::$databases[$name] );
