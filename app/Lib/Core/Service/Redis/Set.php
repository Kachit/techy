<?php
    ...
    class Set extends Base implements \Techy\Lib\Core\Service\I\ISet {
        ...
        public function append( $key, $member ){
            try {
                ...
                Application::instance()->getLogger()->log( 'redis-errors', 'Couldn\'t append data to '. $this->name . $key .' ['. $member .']' );
            }
            return false;
        }
