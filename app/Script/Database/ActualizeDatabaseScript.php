<?php
    ...
    abstract class ActualizeDatabaseScript extends \Techy\Script\Base {

        protected $version;
        protected $dbName;

        /**
         * @var \Techy\Lib\Core\Database\I\IDatabase $Database
         */
        protected $Database;

        /**
         * @var \Techy\Lib\Core\Database\I\IConfig $Config
         */
        protected $Config;
        ...
        public function run(){
            ...
            $this->Config = \Techy\Config\Database::instance( $this->dbName );
            $this->processDb();
//            $this->backup();
        }
...
SQL
    ...
    CREATE TABLE IF NOT EXISTS version ( version int PRIMARY KEY );
