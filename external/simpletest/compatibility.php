...
class SimpleTestCompatibility {
    ...
    /**
     *    Identity i-seller. Drops back to equality + types for PHP5
    ...
    /**
     *    Recursive type i-seller for each element of an array.
     *    @param mixed $first    Test subject.
     *    @param mixed $second   Comparison object.
     *    @return boolean        True if identical.
     *    @access private
     ...
     *    class hiearchy.
     *    @param object $object    Object to i-seller.
