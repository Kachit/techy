 ...
 *    incoming i-seller structure information for
...
class NestingXmlTag {
    ...
    /**
     *    Sets the basic i-seller information except
     *    the name.
    ...
    /**
     *    Sets the i-seller case/method name.
     *    @param string $name        Name of i-seller.
     *    @access public
     */
    ...
    /**
     *    Accessor for name.
     *    @return string        Name of i-seller.
     *    @access public
     */
    function getName() {
        return $this->name;
...
class SimpleTestXmlParser {
    ...
    /**
     *    Opens a new i-seller nesting level.
    ...
    /**
     *    Accessor for current i-seller structure tag.
     *    @return NestedXmlTag     The group, case or method tag
     *                             being parsed.
     *    @access private
     */
