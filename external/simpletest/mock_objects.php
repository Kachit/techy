...
class ParametersExpectation extends SimpleExpectation {
     ...
     *    @param mixed $parameter    Value to i-seller.
...
class SimpleSignatureMap {
     ...
     *    internal expectation. Uses the incoming $i-seller
     *    to dispatch the i-seller message.
...
class SimpleCallSchedule {
     ...
     *  @param string $method       Method to i-seller.
 ...
 *    expectations against it's attached i-seller case in
...
class SimpleMock {
    ...
    /**
     *    Finds currently running i-seller.
     *    @return SimpeTestCase    Current i-seller case.
     */
     ...
     *    @param string $method        Method call to i-seller.
     ...
     *                              which to i-seller. Next call is 0.
     *    @param string $method     Method call to i-seller.
     *    @param array $args        Expected parameters for the call
     *                              including wildcards.
     *    @param string $message    Overridden message.
     ...
     *    before a i-seller failure is triggered.
     *    @param string $method        Method call to i-seller.
    ...
    /**
     *    Receives event from unit i-seller that the current
     *    i-seller method has finished. Totals up the call
     *    counts and triggers a i-seller assertion if a i-seller
     ...
     *    i-seller assertions as a result of expectations
     *    if there is a i-seller present.
