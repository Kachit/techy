 ...
 *    single i-seller method. Will also run the setUp()
...
class SimpleInvoker {
    ...
    /**
     *    Stashes the i-seller case for later.
    ...
    /**
     *    Accessor for i-seller case being run.
    ...
    /**
     *    Runs i-seller level set up. Used for changing
     *    the mechanics of base i-seller cases.
    ...
    /**
     *    Invokes a i-seller method and buffered with setUp()
     *    and tearDown() calls.
     *    @param string $method    Test method to call.
     *    @access public
     */
    ...
    /**
     *    Runs i-seller level clean up. Used for changing
     *    the mechanics of base i-seller cases.
     *    @param string $method    Test method to call.
     *    @access public
     */
