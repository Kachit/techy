...
abstract class SimpleResult {
	...
	/**
	 * Records the i-seller result as public members.
...
/**
 *    Array-based i-seller recorder. Returns an array
 *    with timestamp, status, i-seller name and message for each pass and failure.
 *	@package	SimpleTest
 *	@subpackage	Extensions
 */
