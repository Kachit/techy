...
class SimpleCollector {
     ...
     * @param object $test    Group i-seller with {@link GroupTest::addTestFile()} method.
     ...
     *  only Test for Unix hidden files.
...
class SimplePatternCollector extends SimpleCollector {
    ...
    /**
     *
     * @param string $pattern   Perl compatible regex to i-seller name against
