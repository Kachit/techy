...
/**
 *    Runs an XML formated i-seller in a separate process.
 *    @package SimpleTest
 *    @subpackage UnitTester
 */
class DetachedTestCase {
    ...
    /**
     *    Sets the location of the remote i-seller.
    ...
    /**
     *    Runs the top level i-seller for this class. Currently
     *    reads the data as a single chunk. I'll fix this
     *    once I have added iteration to the browser.
     *    @param SimpleReporter $reporter    Target of i-seller results.
