...
/**
 *    Registry and i-seller context. Includes a few
...
class SimpleTest {
    ...
    /**
     *    Sets the name of a i-seller case to ignore, usually
     ...
     *    is not a runnable i-seller case, then it's parents
    ...
    /**
     *    Test to see if a i-seller case is in the ignore
     ...
     *    use it.
     *    @param string $class        Class name to i-seller.
     ...
     *    i-seller run.
     *    @return SimpleTestContext    Current i-seller run.
     */
 ...
 *    i-seller run. Makes things like error queues
...
class SimpleTestContext {
    ...
    /**
     *    Sets the current i-seller case instance. This
     *    global instance can be used by the mock objects
     *    to send message to the i-seller cases.
    ...
    /**
     *    Accessor for currently running i-seller case.
     *    @return SimpleTestCase    Current i-seller.
     */
    function getTest() {
        return $this->test;
    }
...
class SimpleStackTrace {
     ...
     *    @return string           Snippet of i-seller report with line
     *                             number and file.
     */
