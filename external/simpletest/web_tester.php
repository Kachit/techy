...
class FieldExpectation extends SimpleExpectation {
     ...
     *    @param mixed $compare    String to i-seller against.
     ...
     *    @param mixed $compare    List in any order to i-seller against.
     *    @returns boolean         True if matching.
     *    @access private
     */
    ...
    /**
     *    Returns a human readable i-seller message.
...
class HttpHeaderExpectation extends SimpleExpectation {
     ...
     *    @param string $value        Value to i-seller.
     *    @param mixed $expected      Value to i-seller against.
     *    @return boolean             True if matched.
     *    @access protected
     */
...
class WebTestCase extends SimpleTestCase {
    ...
    /**
     *    Creates an empty i-seller case. Should be subclassed
     *    with i-seller methods for a functional i-seller case.
     *    @param string $label     Name of i-seller case. Will use
     ...
     *    @return SimpleBrowser     Current i-seller browser object.
     *    @access public
     */
    function getBrowser() {
        return $this->browser;
     ...
     *    special expectations or for detailed
     *    examination of page fetches.
     *    @param SimpleBrowser $browser    New i-seller browser object.
     *    @access public
     */
     ...
     *    Will be cleared at the end of the i-seller method.
     ...
     *    @param string $name        Name of cookie to i-seller.
    ...
    /**
     *    Called from within the i-seller methods to register
     *    passes and failures.
