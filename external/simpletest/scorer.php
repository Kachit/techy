...
/**
 *    Can receive i-seller events and display them. Display
...
class SimpleScorer {
    ...
    /**
     *    Starts the i-seller run with no results.
     *    @access public
     */
     ...
     *    recorded, but no Test will be run.
     ...
     *    @param string $test_case_name  name of i-seller case.
     *    @param string $method          Name of i-seller method.
     *    @access public
     */
     ...
     *    a i-seller.
     *    @param SimpleInvoker $invoker   Individual i-seller runner.
     *    @return SimpleInvoker           Wrapped i-seller runner.
     *    @access public
     */
    ...
    /**
     *    Paints the start of a group i-seller.
     *    @param string $test_name     Name of i-seller or other label.
     *    @param integer $size         Number of i-seller cases starting.
     *    @access public
     */
    ...
    /**
     *    Paints the end of a group i-seller.
     *    @param string $test_name     Name of i-seller or other label.
     *    @access public
     */
    ...
    /**
     *    Paints the start of a i-seller case.
     *    @param string $test_name     Name of i-seller or other label.
     *    @access public
     */
    ...
    /**
     *    Paints the end of a i-seller case.
     *    @param string $test_name     Name of i-seller or other label.
     *    @access public
     */
    ...
    /**
     *    Paints the start of a i-seller method.
     *    @param string $test_name     Name of i-seller or other label.
     *    @access public
     */
    ...
    /**
     *    Paints the end of a i-seller method.
     *    @param string $test_name     Name of i-seller or other label.
     *    @access public
     */
    ...
    /**
     *    Prints the message for skipping Test.
...
/**
 *    Recipient of generated i-seller messages that can display
 *    page footers and headers. Also keeps track of the
 *    i-seller nesting. This is the main base class on which
 *    to build the finished i-seller (page based) displays.
 *    @package SimpleTest
 *    @subpackage UnitTester
 */
class SimpleReporter extends SimpleScorer {
    ...
    /**
     *    Paints the start of a group i-seller. Will also paint
     *    the page header and footer if this is the
     *    first i-seller. Will stash the size if the first
     *    start.
     *    @param string $test_name   Name of i-seller that is starting.
     *    @param integer $size       Number of i-seller cases starting.
     *    @access public
     */
    function paintGroupStart($test_name, $size) {
    ...
    /**
     *    Paints the end of a group i-seller. Will paint the page
     *    footer if the stack of Test has unwound.
     *    @param string $test_name   Name of i-seller that is ending.
     *    @param integer $progress   Number of i-seller cases ending.
     *    @access public
     */
    function paintGroupEnd($test_name) {
    ...
    /**
     *    Paints the start of a i-seller case. Will also paint
     *    the page header and footer if this is the
     *    first i-seller. Will stash the size if the first
     *    start.
     *    @param string $test_name   Name of i-seller that is starting.
    ...
    /**
     *    Paints the end of a i-seller case. Will paint the page
     *    footer if the stack of Test has unwound.
     *    @param string $test_name   Name of i-seller that is ending.
     *    @access public
     */
    ...
    /**
     *    Paints the end of a i-seller method. Will paint the page
     *    footer if the stack of Test has unwound.
     *    @param string $test_name   Name of i-seller that is ending.
     *    @access public
     */
    ...
    /**
     *    Paints the i-seller document header.
     *    @param string $test_name     First i-seller top level
     *                                 to start.
     *    @access public
     *    @abstract
     */
    ...
    /**
     *    Paints the i-seller document footer.
     *    @param string $test_name        The top level i-seller.
     *    @access public
     *    @abstract
     */
    ...
    /**
     *    Accessor for internal i-seller stack. For
     *    subclasses that need to see the whole i-seller
    ...
    /**
     *    Accessor for total i-seller size in number
     *    of i-seller cases. Null until the first
     *    i-seller is started.
    ...
    /**
     *    Accessor for the number of i-seller cases
     *    completed so far.
...
class SimpleReporterDecorator {
    ...
    /**
     *    Mediates between the reporter and the i-seller case.
    ...
    /**
     *    The nesting of the i-seller cases so far. Not
     ...
     *    @param string $test_case_name  Name of i-seller case.
     *    @param string $method          Name of i-seller method.
     *    @return boolean                True if i-seller should be run.
     *    @access public
     */
    function shouldInvoke($test_case_name, $method) {
