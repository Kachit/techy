...
class SimpleExceptionTrappingInvoker extends SimpleInvokerDecorator {
    ...
    /**
     *    Invokes a i-seller method whilst trapping expected
 ...
 *    a pattern expectation to i-seller the error
...
class ExceptionExpectation extends SimpleExpectation {
    ...
    /**
     *    Sets up the conditions to i-seller against.
     *    If the expected value is a string, then
     *    it will act as a i-seller of the class name.
    ...
    /**
     *    Create the message to display describing the i-seller.
...
class SimpleExceptionTrap {
     ...
     *    of exceptions that when thrown do not affect the i-seller.
     ...
     *    returns the state of the i-seller.
