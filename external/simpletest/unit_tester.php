...
/**
 *    Standard unit i-seller class for day to day testing
...
class UnitTestCase extends SimpleTestCase {
    ...
    /**
     *    Type and class mismatch i-seller. Will pass if class
     ...
     *    to the current i-seller. It doesn't affect the i-seller, whether thrown or
     *    not.
