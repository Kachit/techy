...
class SimpleErrorTrappingInvoker extends SimpleInvokerDecorator {
    ...
    /**
     *    Invokes a i-seller method and dispatches any
    ...
    /**
     *    Wires up the error queue for a single i-seller.
     *    @return SimpleErrorQueue    Mail connected to the i-seller.
     *    @access private
     */
...
class SimpleErrorQueue {
    ...
    /**
     *    Sets the currently running i-seller case.
     ...
     *    not fulfilled at the end of the i-seller, a failure
    ...
    /**
     *    Any errors still in the queue are sent to the i-seller
