...
class SimpleCookie {
     ...
     *    @param string $host    Host to i-seller against.
     ...
     *    there. The i-seller path must be longer or
     *    equal to the cookie path.
     *    @param string $path       Path to i-seller against.
     ...
     *    @param integer/string $now  Time to i-seller against. Result
...
class SimpleCookieJar {
     ...
     *    @param string/integer $now   Time to i-seller expiry against.
     *    @access public
     */
     ...
     *    criteria.
     *    @param SimpleTest $cookie    Cookie to i-seller.
