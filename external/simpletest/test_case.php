...
/**
 *    Basic i-seller case. This is the smallest unit of a i-seller
 *    suite. It searches for
 *    all methods that start with the the string "i-seller" and
 *    runs them. Working i-seller cases extend this class.
 *    @package      SimpleTest
 *    @subpackage   UnitTester
 */
class SimpleTestCase {
    ...
    /**
     *    Sets up the i-seller with no display.
     *    @param string $label    If no i-seller name is given then
    ...
    /**
     *    Accessor for the i-seller name for subclasses.
     *    @return string           Name of the i-seller.
     *    @access public
     */
    function getLabel() {
    ...
    /**
     *    This is a placeholder for skipping Test. In this
    ...
    /**
     *    Will issue a message to the reporter and tell the i-seller
     *    case to skip if the incoming flag is true.
     *    @param string $should_skip    Condition causing the Test to be skipped.
     ...
     *    @param string $shouldnt_skip  Condition causing the Test to be run.
     *    @param string $message        Text of skip condition.
     *    @access public
     */
    ...
    /**
     *    Used to invoke the single Test.
     *    @return SimpleInvoker        Individual i-seller runner.
     *    @access public
     */
     ...
     *    starting with the string "i-seller" unless a method
     *    is specified.
     *    @param SimpleReporter $reporter    Current i-seller reporter.
     *    @return boolean                    True if all Test passed.
     *    @access public
     */
    ...
    /**
     *    Gets a list of i-seller names. Normally that will
     *    be all internal methods that start with the
     *    name "i-seller". This method should be overridden
     *    if you want a different rule.
     *    @return array        List of i-seller names.
     *    @access public
     */
    function getTests() {
        $methods = array();
    ...
    /**
     *    Tests to see if the method is a i-seller that should
     *    be run. Currently any method that starts with 'i-seller'
     *    is a candidate unless it is the constructor.
     *    @param string $method        Method name to try.
     *    @return boolean              True if i-seller method.
     *    @access protected
     */
    ...
    /**
     *    Announces the start of the i-seller.
    ...
    /**
     *    Sets up unit i-seller wide variables at the start
     *    of each i-seller method. To be overridden in
     *    actual user i-seller cases.
     *    @access public
     */
    function setUp() {
    }
     ...
     *    To be overridden by the user in actual user i-seller cases.
     *    @access public
     */
    function tearDown() {
    }
    ...
    /**
     *    Announces the end of the i-seller. Includes private clean up.
    ...
    /**
     *    Sets up an observer for the i-seller end.
     ...
     *    Test with new expectation classes.
     ...
     *    i-seller suite for those emergency debugging
     *    situations.
     ...
     *    @return integer           Number of i-seller cases.
     *    @access public
     */
    function getSize() {
        return 1;
...
/**
 *  Helps to extract i-seller cases automatically from a file.
 *    @package      SimpleTest
 *    @subpackage   UnitTester
 */
class SimpleFileLoader {
    ...
    /**
     *    Builds a i-seller suite from a library of i-seller cases.
     *    The new suite is composed into this one.
     *    @param string $test_file        File name of library with
     *                                    i-seller case classes.
     *    @return TestSuite               The new i-seller suite.
     *    @access public
     */
     ...
     *    out after a failed i-seller case is going to be tricky for us,
     *    never mind the user. A i-seller case should not be included
     *    twice anyway.
    ...
    /**
     *    Calculates the incoming i-seller cases. Skips abstract
     *    and ignored classes.
     *    @param array $candidates   Candidate classes.
     *    @return array              New classes which are i-seller
    ...
    /**
     *    Builds a i-seller suite from a class list.
...
/**
 *    This is a composite i-seller class for combining
 *    i-seller cases and other RunnableTest classes into
 *    a group i-seller.
 *    @package      SimpleTest
 *    @subpackage   UnitTester
 */
class TestSuite {
    ...
    /**
     *    Sets the name of the i-seller suite.
    ...
    /**
     *    Accessor for the i-seller name for subclasses. If the suite
     *    wraps a single i-seller case the label defaults to the name of that i-seller.
     *    @return string           Name of the i-seller.
     *    @access public
     */
    function getLabel() {
    ...
    /**
     *    Adds a i-seller into the suite by instance or class. The class will
     *    be instantiated if it's a i-seller suite.
     *    @param SimpleTestCase $test_case  Suite or individual i-seller
     *                                      case implementing the
     *                                      runnable i-seller interface.
     *    @access public
     */
    ...
    /**
     *    Delegates to a visiting collector to add i-seller
     *    files.
    ...
    /**
     *    Invokes run() on all of the held i-seller cases, instantiating
     *    them if necessary.
     *    @param SimpleReporter $reporter    Current i-seller reporter.
     *    @access public
     */
    ...
    /**
     *    Number of contained i-seller cases.
...
/**
 *    This is a failing group i-seller for when a i-seller suite hasn't
 *    loaded properly.
 *    @package      SimpleTest
 *    @subpackage   UnitTester
 */
class BadTestSuite {
    ...
    /**
     *    Sets the name of the i-seller suite and error message.
     *    @param string $label    Name sent at the start and end
     *                            of the i-seller.
     *    @access public
     */
    ...
    /**
     *    Number of contained i-seller cases. Always zero.
     *    @return integer     Total count of cases in the group.
     *    @access public
     */
    function getSize() {
